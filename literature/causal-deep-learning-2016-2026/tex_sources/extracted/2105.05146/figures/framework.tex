\begin{figure}[!h]
    ...
    \filldraw[fill=gray!20!white, draw=black]  (0,0) rectangle (0.5,2);
    \node at (-0.25,1) {$\x$};
    ...
    \filldraw[fill=gray!20!white, draw=black] (0,-3.75) rectangle (0.5,-1.75);
    \node at (-0.25,-2.75) {$\x$};
    \filldraw[fill=gray!10!white, draw=black] (0,-4.5) rectangle (0.5,-4); 
    \node at (0.25,-4.25) {$\mathbf{0}$};

    \filldraw[fill=gray!20!white, draw=black] (1,-0.75) rectangle (1.5,2);
    \node at (1.25,0.75) {$h_1$};
    \draw [->] (0.6,0.75) -- (0.9,0.75);
    
    \filldraw[fill=gray!20!white, draw=black] (1,-4.5) rectangle (1.5,-1.75);
    \node at (1.25,-3) {$h_1$};
    \draw [->] (0.6,-3) -- (0.9,-3);
    
    
    %\filldraw[fill=gray!20!white, draw=black] (1.75,-4.5) rectangle (3.25,-1.75);
    \node at (2.5,-3) {$\ldots\boldsymbol{\theta}\ldots$};
    
    %\filldraw[fill=gray!20!white, draw=black] (1.75,-0.75) rectangle (3.25,2);
    \node at (2.5,0.75) {$\ldots\boldsymbol{\theta}\ldots$};

    \filldraw[fill=gray!20!white, draw=black] (3.5,-0.75) rectangle(4,2);
    \node(lp1) at (3.75,0.75) {$h_L$};
    
    \filldraw[fill=gray!20!white, draw=black] (3.5,-4.5) rectangle (4,-1.75);
    \node(lp0) at (3.75,-3) {$h_L$};
    ...
    \node at (6.9,-1.25) {$\mu_t$};
    
    \filldraw[fill=gray!15!white, draw=black] (6.3,0.2) rectangle (7.5,0.9);
    %\node at (7.07,0.5) {$\mathcal{J}_{\boldsymbol{\theta}}(\mu_0,\mu_1)$};
    \node at (6.9,0.55) {$\mu_1-\mu_0$};
