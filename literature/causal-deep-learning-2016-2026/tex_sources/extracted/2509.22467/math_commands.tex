...
\newcommand{\distribution}[1][]{\ensuremath{{P}_{#1}}\xspace}
\newcommand{\cumulative}[1][]{\ensuremath{F_{#1}}\xspace}
\newcommand{\empcumulative}[1][]{\ensuremath{\hat F_{#1}}\xspace}
\newcommand{\pushforward}[2]{{#1}_{\#} {#2}}

\DeclareMathOperator{\E}{\mathbb{E}}
\DeclarePairedDelimiter{\Ebrackets}{[}{]}
\newcommand{\Expect}[2][]{\E_{#1}\Ebrackets{#2}}
\WithSuffix\newcommand\Expect*[2][]{\E_{#1}\Ebrackets*{#2}}

\DeclareMathOperator{\V}{\mathbb{V}}
\newcommand{\Var}[2][]{\V_{#1}\Ebrackets{#2}}

\newcommand{\normal}{\ensuremath{\mathcal{N}}\xspace}
\newcommand{\uniform}{\ensuremath{\mathcal{U}}\xspace}
\newcommand{\categorical}{\ensuremath{\operatorname{Cat}}\xspace}
\newcommand{\bernoulli}{\ensuremath{\operatorname{Bern}}\xspace}
\newcommand{\binomial}{\ensuremath{\operatorname{Bin}}\xspace}
\newcommand{\lognormal}{\ensuremath{\operatorname{Log-normal}}\xspace}
\newcommand{\poisson}{\ensuremath{\operatorname{Poiss}}\xspace}
\newcommand{\exponentialdistribution}{\ensuremath{\operatorname{Exp}}\xspace}
\newcommand{\betadistribution}{\ensuremath{\operatorname{Beta}}\xspace}
\newcommand{\weibulldistribution}{\ensuremath{\operatorname{Weibull}}\xspace}

\newcommand{\identity}{\ensuremath{\mI}}
\newcommand{\indicator}[1]{\ensuremath{\mathbf{1}_{\{#1\}}}}
\newcommand{\ones}{\ensuremath{\mathbf{1}}\xspace}
\newcommand{\zeroes}{\ensuremath{\mathbf{0}}\xspace}
...
\newcommand{\itemvi}{{\bfseries \color{maincolor} vi)}\xspace}
\newcommand{\itemvii}{{\bfseries \color{maincolor} vii)}\xspace}
...
% \newcommand{\parents}[1]{{\ensuremath{\mathrm{pa}_{#1}}\xspace}}
% \newcommand{\ancestors}[1]{{\ensuremath{\mathrm{an}_{#1}}\xspace}}
% \newcommand{\children}[1]{{\ensuremath{\mathrm{ch}_{#1}}\xspace}}

\newcommand{\parents}[1]{{\ensuremath{\mathrm{pa}(#1)}\xspace}}
\newcommand{\ancestors}[1]{{\ensuremath{\mathrm{an}(#1)}\xspace}}
\newcommand{\children}[1]{{\ensuremath{\mathrm{ch}(#1)}\xspace}}
